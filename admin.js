...
productForm.addEventListener('submit', function(event){
    ...
    xhr.open("POST", "https://market-48dc.restdb.io/rest/product");
    xhr.setRequestHeader("content-type", "application/json");
    xhr.setRequestHeader("x-apikey", "63c2e0a6969f06502871ae7c");
...
let xhr = new XMLHttpRequest();
xhr.open("GET", "https://market-48dc.restdb.io/rest/orders");
...
function complete(id) {
    ...
    xhr.open("PUT", "https://market-48dc.restdb.io/rest/orders/"+id);
    xhr.setRequestHeader("content-type", "application/json");
    xhr.setRequestHeader("x-apikey", "63c2e0a6969f06502871ae7c");
    xhr.setRequestHeader("cache-control", "no-cache");
